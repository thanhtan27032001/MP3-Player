...
import 'package:mp3_player/app/page/song_detail/song_detail_provider.dart';
...
class _SongDetailPageState extends State<SongDetailPage> {
  ...
  void initState() {
    super.initState();
    Provider.of<SongDetailProvider>(context, listen: false).fetchSongDetail();
  }

  @override
  void dispose() {
    Provider.of<SongDetailProvider>(context, listen: false).player?.dispose();
    super.dispose();
  }
                ...
                children: <Widget>[
                  ...
                  Container(
                    ...
                    child: IconButton(
                      ...
                      onPressed: () {
                        Provider.of<SongDetailProvider>(context).playSong();
                      },
                    ),
                  ),
                  IconButton(
